...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-snoocore/node_modules/snoocore/build/src/Throttle.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-snoocore/node_modules/snoocore/build/src/Throttle.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-snoocore/node_modules/snoocore/build/src/</a> &#187; Throttle.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    var throttleMs = arguments.length &lt;= 0 || arguments[0] === undefined ? 1000 : arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Throttle);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._throttleMs = throttleMs;</span>
&nbsp;
    /*
     ...
     */
<span class="cstat-no" title="statement not covered" >    this._throttleDelay = 1;</span>
  }
&nbsp;
  _createClass(Throttle, [{
    key: 'wait',
    value: <span class="fstat-no" title="function not covered" >function wait() {</span>
<span class="cstat-no" title="statement not covered" >      var _this = this;</span>
&nbsp;
      // resolve this promise after the current throttleDelay
<span class="cstat-no" title="statement not covered" >      var delayPromise = (0, _whenDelay2['default'])(this._throttleDelay);</span>
&nbsp;
      // add throttleMs to the total throttleDelay
<span class="cstat-no" title="statement not covered" >      this._throttleDelay += this._throttleMs;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        _this._throttleDelay -= _this._throttleMs;</span>
      }, this._throttleMs);
&nbsp;
<span class="cstat-no" title="statement not covered" >      return delayPromise;</span>
    }
&nbsp;
    /*
    ...
    */
    ...
    key: 'addTime',
    value: <span class="fstat-no" title="function not covered" >function addTime(timeMs) {</span>
<span class="cstat-no" title="statement not covered" >      this._throttleDelay += timeMs;</span>
    }
  }]);
&nbsp;
  return Throttle;
